	...
	if $CollisionPolygon2D.get_child_count() != 0:
		for i in range(0, get_child_count()):
			if i == 0:
				...
				$CollisionPolygon2D/Polygon2D.color = Color(0.411765, 0.411765, 0.411765, 1)
			else:
				get_node("CollisionPolygon2D"+ str(i+1) + "/Polygon2D").polygon = get_node("CollisionPolygon2D"+ str(i+1)).polygon
				get_node("CollisionPolygon2D"+ str(i+1) + "/Polygon2D").color = Color(0.411765, 0.411765, 0.411765, 1)
